...
INSTALL_CRDOWNLOADER(){
	...
	wget "https://github.com/anidl/multi-downloader-nx/releases/download/v4.7.1/multi-downloader-nx-linux-gui.7z"
	...
	sed -i 's/ws:\/\//wss:\/\//g' /content/tools/multi-downloader-nx-ubuntu64-gui/gui/server/build/gui/react/src/provider/MessageChannel.js
